...
const I18N = {
  ...
  hero: {
    name1: { es: 'ALEN', en: 'ALEN' },
    name2: { es: 'GÓMEZ.', en: 'GÓMEZ.' },
    line1: { es: 'ALEN', en: 'ALEN' },
    line2: { es: 'GÓMEZ.', en: 'GÓMEZ.' },
    line3: { es: 'DIRECTOR DE ARTE DESDE', en: 'ART DIRECTOR SINCE' },
    roleLine: { es: 'Art Director & Senior Designer', en: 'Art Director & Senior Designer' },
    role: { es: 'Art Director', en: 'Art Director' },
    role2: { es: 'Senior Designer', en: 'Senior Designer' },
  ...
  sections: {
    ...
    services: { es: 'Qué hago', en: 'What I do' },
    clients: { es: 'Clientes & agencias', en: 'Clients & agencies' },
  },
  about: {
