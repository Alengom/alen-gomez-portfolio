      ...
      <section style={{ padding: isNarrow ? '96px 20px 72px' : '160px 40px 120px' }}>
        <div style={{ maxWidth: 1200, margin: '0 auto' }}>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: isNarrow ? '1fr' : '1fr 1.5fr', gap: isNarrow ? 32 : 80, marginTop: isNarrow ? 36 : 80, alignItems: 'start' }}>
            <img src="/public/images/FOTO_WORK.png" alt={lang === 'es' ? 'Retrato de Alen Gómez, director de arte' : 'Portrait of Alen Gómez, art director'} style={{ width: '100%', maxWidth: isNarrow ? 300 : 'none', margin: isNarrow ? '0 auto' : 0, display: 'block', filter: 'grayscale(1)', borderRadius: isNarrow ? 12 : 0 }} />
            <div>
